...
start "TradeBerg Backend" cmd /k "cd backend && if exist venv\Scripts\activate.bat (call venv\Scripts\activate.bat) && python -m uvicorn app:app --reload --host 0.0.0.0 --port 8080"
